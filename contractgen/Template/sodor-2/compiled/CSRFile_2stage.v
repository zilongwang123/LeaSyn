module CSRFile_2stage (
	...
	// Trace: core/CSRFile_2stage.v:2:3
	input clock;
	// Trace: core/CSRFile_2stage.v:3:3
	input reset;
	// Trace: core/CSRFile_2stage.v:4:3
	input io_ungated_clock;
	// Trace: core/CSRFile_2stage.v:5:3
	input io_interrupts_debug;
	// Trace: core/CSRFile_2stage.v:6:3
	input io_interrupts_mtip;
	// Trace: core/CSRFile_2stage.v:7:3
	input io_interrupts_msip;
	// Trace: core/CSRFile_2stage.v:8:3
	input io_interrupts_meip;
	// Trace: core/CSRFile_2stage.v:9:3
	input io_hartid;
	// Trace: core/CSRFile_2stage.v:10:3
	input [11:0] io_rw_addr;
	// Trace: core/CSRFile_2stage.v:11:3
	input [2:0] io_rw_cmd;
	// Trace: core/CSRFile_2stage.v:12:3
	output wire [31:0] io_rw_rdata;
	// Trace: core/CSRFile_2stage.v:13:3
	input [31:0] io_rw_wdata;
	// Trace: core/CSRFile_2stage.v:14:3
	output wire io_csr_stall;
	// Trace: core/CSRFile_2stage.v:15:3
	output wire io_eret;
	// Trace: core/CSRFile_2stage.v:16:3
	output wire io_singleStep;
	// Trace: core/CSRFile_2stage.v:17:3
	output wire io_status_debug;
	// Trace: core/CSRFile_2stage.v:18:3
	output wire io_status_cease;
	// Trace: core/CSRFile_2stage.v:19:3
	output wire io_status_wfi;
	// Trace: core/CSRFile_2stage.v:20:3
	output wire [31:0] io_status_isa;
	// Trace: core/CSRFile_2stage.v:21:3
	output wire [1:0] io_status_dprv;
	// Trace: core/CSRFile_2stage.v:22:3
	output wire io_status_dv;
	// Trace: core/CSRFile_2stage.v:23:3
	output wire [1:0] io_status_prv;
	// Trace: core/CSRFile_2stage.v:24:3
	output wire io_status_v;
	// Trace: core/CSRFile_2stage.v:25:3
	output wire io_status_sd;
	// Trace: core/CSRFile_2stage.v:26:3
	output wire [22:0] io_status_zero2;
	// Trace: core/CSRFile_2stage.v:27:3
	output wire io_status_mpv;
	// Trace: core/CSRFile_2stage.v:28:3
	output wire io_status_gva;
	// Trace: core/CSRFile_2stage.v:29:3
	output wire io_status_mbe;
	// Trace: core/CSRFile_2stage.v:30:3
	output wire io_status_sbe;
	// Trace: core/CSRFile_2stage.v:31:3
	output wire [1:0] io_status_sxl;
	// Trace: core/CSRFile_2stage.v:32:3
	output wire [1:0] io_status_uxl;
	// Trace: core/CSRFile_2stage.v:33:3
	output wire io_status_sd_rv32;
	// Trace: core/CSRFile_2stage.v:34:3
	output wire [7:0] io_status_zero1;
	// Trace: core/CSRFile_2stage.v:35:3
	output wire io_status_tsr;
	// Trace: core/CSRFile_2stage.v:36:3
	output wire io_status_tw;
	// Trace: core/CSRFile_2stage.v:37:3
	output wire io_status_tvm;
	// Trace: core/CSRFile_2stage.v:38:3
	output wire io_status_mxr;
	// Trace: core/CSRFile_2stage.v:39:3
	output wire io_status_sum;
	// Trace: core/CSRFile_2stage.v:40:3
	output wire io_status_mprv;
	// Trace: core/CSRFile_2stage.v:41:3
	output wire [1:0] io_status_xs;
	// Trace: core/CSRFile_2stage.v:42:3
	output wire [1:0] io_status_fs;
	// Trace: core/CSRFile_2stage.v:43:3
	output wire [1:0] io_status_mpp;
	// Trace: core/CSRFile_2stage.v:44:3
	output wire [1:0] io_status_vs;
	// Trace: core/CSRFile_2stage.v:45:3
	output wire io_status_spp;
	// Trace: core/CSRFile_2stage.v:46:3
	output wire io_status_mpie;
	// Trace: core/CSRFile_2stage.v:47:3
	output wire io_status_ube;
	// Trace: core/CSRFile_2stage.v:48:3
	output wire io_status_spie;
	// Trace: core/CSRFile_2stage.v:49:3
	output wire io_status_upie;
	// Trace: core/CSRFile_2stage.v:50:3
	output wire io_status_mie;
	// Trace: core/CSRFile_2stage.v:51:3
	output wire io_status_hie;
	// Trace: core/CSRFile_2stage.v:52:3
	output wire io_status_sie;
	// Trace: core/CSRFile_2stage.v:53:3
	output wire io_status_uie;
	// Trace: core/CSRFile_2stage.v:54:3
	output wire [31:0] io_evec;
	// Trace: core/CSRFile_2stage.v:55:3
	input io_exception;
	// Trace: core/CSRFile_2stage.v:56:3
	input io_retire;
	// Trace: core/CSRFile_2stage.v:57:3
	input [31:0] io_cause;
	// Trace: core/CSRFile_2stage.v:58:3
	input [31:0] io_pc;
	// Trace: core/CSRFile_2stage.v:59:3
	input [31:0] io_tval;
	// Trace: core/CSRFile_2stage.v:60:3
	output wire [31:0] io_time;
	// Trace: core/CSRFile_2stage.v:61:3
	output wire io_interrupt;
	// Trace: core/CSRFile_2stage.v:62:3
	output wire [31:0] io_interrupt_cause;
	// Trace: core/CSRFile_2stage.v:89:3
	reg reg_mstatus_spp;
	// Trace: core/CSRFile_2stage.v:90:3
	reg reg_mstatus_mpie;
	// Trace: core/CSRFile_2stage.v:91:3
	reg reg_mstatus_mie;
	// Trace: core/CSRFile_2stage.v:92:3
	reg reg_dcsr_ebreakm;
	// Trace: core/CSRFile_2stage.v:93:3
	reg [2:0] reg_dcsr_cause;
	// Trace: core/CSRFile_2stage.v:94:3
	reg reg_dcsr_step;
	// Trace: core/CSRFile_2stage.v:95:3
	reg reg_debug;
	// Trace: core/CSRFile_2stage.v:96:3
	reg [31:0] reg_dpc;
	// Trace: core/CSRFile_2stage.v:97:3
	reg [31:0] reg_dscratch;
	// Trace: core/CSRFile_2stage.v:98:3
	reg reg_singleStepped;
	// Trace: core/CSRFile_2stage.v:99:3
	reg [31:0] reg_mie;
	// Trace: core/CSRFile_2stage.v:100:3
	reg [31:0] reg_mepc;
	// Trace: core/CSRFile_2stage.v:101:3
	reg [31:0] reg_mcause;
	// Trace: core/CSRFile_2stage.v:102:3
	reg [31:0] reg_mtval;
	// Trace: core/CSRFile_2stage.v:103:3
	reg [31:0] reg_mscratch;
	// Trace: core/CSRFile_2stage.v:104:3
	reg [31:0] reg_mtvec;
	// Trace: core/CSRFile_2stage.v:105:3
	reg reg_wfi;
	// Trace: core/CSRFile_2stage.v:106:3
	reg [2:0] reg_mcountinhibit;
	// Trace: core/CSRFile_2stage.v:107:3
	wire x79 = reg_mcountinhibit[2];
	// Trace: core/CSRFile_2stage.v:108:3
	reg [5:0] small_;
	// Trace: core/CSRFile_2stage.v:109:3
	wire [5:0] _GEN_34 = {5'd0, io_retire};
	// Trace: core/CSRFile_2stage.v:110:3
	wire [6:0] nextSmall = small_ + _GEN_34;
	// Trace: core/CSRFile_2stage.v:111:3
	wire _T_14 = ~x79;
	// Trace: core/CSRFile_2stage.v:112:3
	wire [6:0] _GEN_0 = (~x79 ? nextSmall : {1'd0, small_});
	// Trace: core/CSRFile_2stage.v:113:3
	reg [57:0] large_;
	// Trace: core/CSRFile_2stage.v:114:3
	wire [57:0] _large_r_T_1 = large_ + 58'h000000000000001;
	// Trace: core/CSRFile_2stage.v:115:3
	wire [57:0] _GEN_1 = (nextSmall[6] & _T_14 ? _large_r_T_1 : large_);
	// Trace: core/CSRFile_2stage.v:116:3
	wire [63:0] value = {large_, small_};
	// Trace: core/CSRFile_2stage.v:117:3
	wire x86 = ~io_csr_stall;
	// Trace: core/CSRFile_2stage.v:118:3
	reg [5:0] small_1;
	// Trace: core/CSRFile_2stage.v:119:3
	wire [5:0] _GEN_35 = {5'd0, x86};
	// Trace: core/CSRFile_2stage.v:120:3
	wire [6:0] nextSmall_1 = small_1 + _GEN_35;
	// Trace: core/CSRFile_2stage.v:121:3
	wire _T_15 = ~reg_mcountinhibit[0];
	// Trace: core/CSRFile_2stage.v:122:3
	wire [6:0] _GEN_2 = (~reg_mcountinhibit[0] ? nextSmall_1 : {1'd0, small_1});
	// Trace: core/CSRFile_2stage.v:123:3
	reg [57:0] large_1;
	// Trace: core/CSRFile_2stage.v:124:3
	wire [57:0] _large_r_T_3 = large_1 + 58'h000000000000001;
	// Trace: core/CSRFile_2stage.v:125:3
	wire [57:0] _GEN_3 = (nextSmall_1[6] & _T_15 ? _large_r_T_3 : large_1);
	// Trace: core/CSRFile_2stage.v:126:3
	wire [63:0] value_1 = {large_1, small_1};
	// Trace: core/CSRFile_2stage.v:127:3
	wire [15:0] _read_mip_T = {4'h0, io_interrupts_meip, 3'h0, io_interrupts_mtip, 3'h0, io_interrupts_msip, 3'h0};
	// Trace: core/CSRFile_2stage.v:129:3
	wire [15:0] read_mip = _read_mip_T & 16'h0888;
	// Trace: core/CSRFile_2stage.v:130:3
	wire [31:0] _GEN_40 = {16'd0, read_mip};
	// Trace: core/CSRFile_2stage.v:131:3
	wire [31:0] pending_interrupts = _GEN_40 & reg_mie;
	// Trace: core/CSRFile_2stage.v:132:3
	wire [14:0] d_interrupts = {io_interrupts_debug, 14'h0000};
	// Trace: core/CSRFile_2stage.v:133:3
	wire [31:0] _m_interrupts_T_3 = ~pending_interrupts;
	// Trace: core/CSRFile_2stage.v:134:3
	wire [31:0] _m_interrupts_T_5 = ~_m_interrupts_T_3;
	// Trace: core/CSRFile_2stage.v:135:3
	wire [31:0] m_interrupts = (reg_mstatus_mie ? _m_interrupts_T_5 : 32'h00000000);
	// Trace: core/CSRFile_2stage.v:136:3
	...
	// Trace: core/CSRFile_2stage.v:139:3
	...
	// Trace: core/CSRFile_2stage.v:176:3
	...
	// Trace: core/CSRFile_2stage.v:178:3
	...
	// Trace: core/CSRFile_2stage.v:180:3
	...
	always @(posedge clock) begin
		...
		if (reset)
			// Trace: core/CSRFile_2stage.v:469:7
			reg_dcsr_step <= 1'h0;
		else if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:471:7
				if (decoded_14)
					// Trace: core/CSRFile_2stage.v:472:9
					reg_dcsr_step <= wdata[2];
			end
		end
		if (reset)
			// Trace: core/CSRFile_2stage.v:476:7
			reg_debug <= 1'h0;
		else if (insn_ret) begin
			begin
				// Trace: core/CSRFile_2stage.v:478:7
				if (io_rw_addr[10] & io_rw_addr[7])
					// Trace: core/CSRFile_2stage.v:479:9
					reg_debug <= 1'h0;
				else
					// Trace: core/CSRFile_2stage.v:481:9
					reg_debug <= _GEN_182;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:484:7
			reg_debug <= _GEN_182;
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:487:7
				if (decoded_15)
					// Trace: core/CSRFile_2stage.v:488:9
					reg_dpc <= _reg_mepc_T_2;
				else
					// Trace: core/CSRFile_2stage.v:490:9
					reg_dpc <= _GEN_183;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:493:7
			reg_dpc <= _GEN_183;
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:496:7
				if (decoded_16)
					// Trace: core/CSRFile_2stage.v:497:9
					reg_dscratch <= wdata;
			end
		end
		if (_io_interrupt_T)
			// Trace: core/CSRFile_2stage.v:501:7
			reg_singleStepped <= 1'h0;
		else
			// Trace: core/CSRFile_2stage.v:503:7
			reg_singleStepped <= _GEN_48;
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:506:7
				if (decoded_8)
					// Trace: core/CSRFile_2stage.v:507:9
					reg_mie <= _reg_mie_T;
			end
		end
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:511:7
				if (decoded_10)
					// Trace: core/CSRFile_2stage.v:512:9
					reg_mepc <= _reg_mepc_T_2;
				else
					// Trace: core/CSRFile_2stage.v:514:9
					reg_mepc <= _GEN_211;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:517:7
			reg_mepc <= _GEN_211;
		if (reset)
			// Trace: core/CSRFile_2stage.v:520:7
			reg_mcause <= 32'h00000000;
		else if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:522:7
				if (decoded_12)
					// Trace: core/CSRFile_2stage.v:523:9
					reg_mcause <= _reg_mcause_T;
				else
					// Trace: core/CSRFile_2stage.v:525:9
					reg_mcause <= _GEN_212;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:528:7
			reg_mcause <= _GEN_212;
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:531:7
				if (decoded_11)
					// Trace: core/CSRFile_2stage.v:532:9
					reg_mtval <= wdata;
				else
					// Trace: core/CSRFile_2stage.v:534:9
					reg_mtval <= _GEN_213;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:537:7
			reg_mtval <= _GEN_213;
		if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:540:7
				if (decoded_9)
					// Trace: core/CSRFile_2stage.v:541:9
					reg_mscratch <= wdata;
			end
		end
		if (reset)
			// Trace: core/CSRFile_2stage.v:545:7
			reg_mtvec <= 32'h00000000;
		else if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:547:7
				if (decoded_6)
					// Trace: core/CSRFile_2stage.v:548:9
					reg_mtvec <= wdata;
			end
		end
		if (reset)
			// Trace: core/CSRFile_2stage.v:552:7
			reg_mcountinhibit <= 3'h0;
		else
			// Trace: core/CSRFile_2stage.v:554:7
			reg_mcountinhibit <= _GEN_315[2:0];
		if (reset)
			// Trace: core/CSRFile_2stage.v:557:7
			small_ <= 6'h00;
		else
			// Trace: core/CSRFile_2stage.v:559:7
			small_ <= _GEN_318[5:0];
		if (reset)
			// Trace: core/CSRFile_2stage.v:562:7
			large_ <= 58'h000000000000000;
		else if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:564:7
				if (decoded_108)
					// Trace: core/CSRFile_2stage.v:565:9
					large_ <= _T_1722[63:6];
				else if (decoded_19)
					// Trace: core/CSRFile_2stage.v:567:9
					large_ <= _T_1719[63:6];
				else
					// Trace: core/CSRFile_2stage.v:569:9
					large_ <= _GEN_1;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:572:7
			large_ <= _GEN_1;
		if (reset)
			// Trace: core/CSRFile_2stage.v:575:7
			io_status_cease_r <= 1'h0;
		else
			// Trace: core/CSRFile_2stage.v:577:7
			io_status_cease_r <= _GEN_279;
	end
	// Trace: core/CSRFile_2stage.v:627:3
	always @(posedge io_ungated_clock) begin
		// Trace: core/CSRFile_2stage.v:628:5
		if (reset)
			// Trace: core/CSRFile_2stage.v:629:7
			reg_wfi <= 1'h0;
		else if ((|pending_interrupts | io_interrupts_debug) | exception)
			// Trace: core/CSRFile_2stage.v:631:7
			reg_wfi <= 1'h0;
		else
			// Trace: core/CSRFile_2stage.v:633:7
			reg_wfi <= _GEN_46;
		if (reset)
			// Trace: core/CSRFile_2stage.v:636:7
			small_1 <= 6'h00;
		else
			// Trace: core/CSRFile_2stage.v:638:7
			small_1 <= _GEN_316[5:0];
		if (reset)
			// Trace: core/CSRFile_2stage.v:641:7
			large_1 <= 58'h000000000000000;
		else if (csr_wen) begin
			begin
				// Trace: core/CSRFile_2stage.v:643:7
				if (decoded_107)
					// Trace: core/CSRFile_2stage.v:644:9
					large_1 <= _T_1717[63:6];
				else if (decoded_18)
					// Trace: core/CSRFile_2stage.v:646:9
					large_1 <= _T_1714[63:6];
				else
					// Trace: core/CSRFile_2stage.v:648:9
					large_1 <= _GEN_3;
			end
		end
		else
			// Trace: core/CSRFile_2stage.v:651:7
			large_1 <= _GEN_3;
	end
endmodule
